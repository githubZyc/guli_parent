...
import com.atguigu.serviceoss.config.ConstantProperties;
...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            ...
            OSS ossClient = new OSSClientBuilder().build(endPoint, constantProperties.getKeyId(), constantProperties.getKeySecret());
